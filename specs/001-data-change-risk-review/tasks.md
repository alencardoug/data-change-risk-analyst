...
- [X] T061 Run `quickstart.md` S1–S8 against a **real model** once (needs `OPENAI_API_KEY` + Postgres; provider is OpenAI / `gpt-4o` per ADR-019). S1–S8 are already automated as e2e with a fake model; this is the live confirmation.
